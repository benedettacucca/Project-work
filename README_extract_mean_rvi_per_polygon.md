...
Valori attesi:
- Range reale osservato: `0.04 – 2.10`
- Valore nodata: `-9999`
...
## Filtri applicati ai valori RVI

| Filtro | Valore | Motivazione |
|--------|--------|-------------|
| Nodata | `-9999` | Valore convenzionale per pixel senza dati |
| Minimo | `< 0.04` | Sotto il minimo reale osservato |
| Massimo | `> 2.10` | Sopra il massimo reale osservato |

I limiti del filtro sono stati determinati empiricamente analizzando la distribuzione dei valori su un campione di file `.tif` RVI dell'area di studio (Jolanda di Savoia, Ferrara).
