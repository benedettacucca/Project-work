...
- La variante `benchmark_C_rolling_origin.py` ripete lo stesso benchmark ma allena la retta radar **solo sul passato** del buco: stress test più severo che sposta il crossover a ~55 giorni e circoscrive la validità della soglia di 35 giorni allo scenario archivio.
